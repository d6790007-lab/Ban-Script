...
1. **Download:** Get the `injector.exe` from the `/bin/` folder.
2. **Launch:** Run `injector.exe` as **Administrator**.
3. **Targeting:** Enter the `Target Player ID` into the prompt and click **Inject**.
4. **Recording:** * Press `Ctrl` + `P` to start the `Physics Recorder`.
...
--- 
![](https://github.com/d6790007-lab/Ban-Script/blob/c4c5440750c4363529c3468436092e6035678cb0/hhh44h.jpg)
